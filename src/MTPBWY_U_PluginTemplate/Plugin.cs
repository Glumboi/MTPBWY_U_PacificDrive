...
namespace MTPBWY_U_PacificDrive;
...
{
    public override string PluginDebugIdentifier { get; set; } = "MTPBWY_U_PacificDrive";
    ...
    private const string _engineIniLocation = @"%USERPROFILE%\AppData\Local\PenDriverPro\Saved\Config\WindowsNoEditor";
    ...
    {
        return Directory.Exists(Environment.ExpandEnvironmentVariables(@"%USERPROFILE%\PenDriverPro\Saved\SaveGames"));
    }

    public void OpenGameSaveLocation()
    {
        Process.Start("explorer.exe", Environment.ExpandEnvironmentVariables(@"%USERPROFILE%\AppData\Local\PenDriverPro\Saved\SaveGames"));
    }
